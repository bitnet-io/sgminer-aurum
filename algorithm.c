...
#undef A_DARK
  ...
  { "aurum", ALGO_AURUM, "", 1, 4096, 1, 0, 0, 0xFF, 0xFFFFULL, 0x0000ffffUL, 0, 0, CL_QUEUE_OUT_OF_ORDER_EXEC_MODE_ENABLE, aurum_regenhash, NULL, queue_sph_kernel, gen_hash, append_x13_compiler_options },
